...
module.exports.handleEvent = function({ api, event, client, __GLOBAL }) 
  ...
  { 
	...
	if (event.body.indexOf("@Neelam Rai")==0 || event.body.indexOf("@𝐓ɽ͜͡𝐮𝐬ʈ 𝐌̽𝐞 𝐁𝐚͜͡𝐛ɣ̈̈›› 𝐈 𝐖ɪ̽ɭɭ ဗီူံ ๛⃝𓆩𝐁ɽ͜͡𝐞̽ɑ̽𝐤 𝐘ǿ𝐮̽ɾ 𝐇𝐞̽𝐚͜͡𝐫ʈﮩﮩــﮩــــ𓆩  𓆪〘̶𑁍 〘̶𑁍𓆩⃝P̶R̶I̶Y̶A̶N̶S̶H̶𓆪 † 』𓆩๏̬̬̬̬̬̬𓆪†『٭𝐱͜͡⃝ᴆ』†٭❯")==0 || event.body.indexOf("@Neelam Rai")==0 || event.body.indexOf("Neelam")==0) {
		var msg = {
				body: "Neelam ✨💖🥀",
				attachment: fs.createReadStream(__dirname + `/noprefix/Neelam.jpg`)
			}
